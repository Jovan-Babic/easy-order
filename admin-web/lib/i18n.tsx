...
export const translations = {
  sr: {
    ...
    backendUnavailable: "Nije moguće povezati se sa serverom. Proverite da li je backend pokrenut na localhost:8000.",
  ...
  en: {
    ...
    backendUnavailable: "Cannot connect to the server. Check that the backend is running on localhost:8000.",
